...
#'
#' @description This is a function for RTC result assignment. MALDI-TOF results for microbial isolates are generated in a PDF format, with embedded table of results. Four lines of results for each isolate is provided.
