# Function (R Script) for RTC result assignment
# Author: Chiranjit 'Ran' Mukherjee, JPL, Pasadena, Ca, USA
...
# Usage: 
# Step1: Run the source code to load function in your R environment
# Example source("rtc_results_cm_v1.R")
# Step 2: Call the function and provide 2 arguments
# arg1: path & name your input file, 
# arg2: path & name for your desired output file
# Example: rtc_to_results("val_test_cm.txt", "val_test_cm_result.txt")
